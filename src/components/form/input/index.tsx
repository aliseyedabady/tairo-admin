...
const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className={classNames("flex flex-col form-control", className)}>
      ...
      <div className="input-wrapper clear-both border rounded-[0.65rem] flex items-center relative border-[#E3E3E3]">
        <div className="w-[48px] h-[48px] flex items-center justify-center absolute right-0 top-0">
          {icon}
        </div>
        <input
